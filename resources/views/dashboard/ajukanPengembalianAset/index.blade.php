...
<div class="container mt-2">
    ...
    <div class="card">
        <h5 class="card-header">Tabel list aset yang dipinjam</h5>
            ...
            <table class="table" id="dataAset">
                <thead>
                    <tr>
                        ...
                        <th>sisa waktu peminjaman (hari)</th>
                        <th>status</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody class="table-border-bottom-0">
                    @forelse ($datapinjam as $key=>$item)
                    <tr>
                        <td>{{ $item->aset->nama }}</td>
                        <td class="text-center">{{ $item->jumlah }}</td>
                        <td class="text-center">{{ $item->tanggal_mulai_pinjam }}</td>
                        <td class="text-center">{{ $sisawaktu[$key] }}</td>
